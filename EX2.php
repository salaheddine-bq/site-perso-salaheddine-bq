<?php
$employes = [
    ["nom" => "Hicham", "poste" => "Développeur", "salaire" => 9000],
    ["nom" => "Mohamed", "poste" => "réseaux", "salaire" => 40000],
    ["nom" => "Youssef", "poste" => "Ingenieur", "salaire" => 4800],
    ["nom" => "omar", "poste" => "Comptable", "salaire" => 6000],
    ["nom" => "Badr", "poste" => "Technicien", "salaire" => 3500]
];
...
<body>
    ...
    $utilisateurs = [
        ...
        ["email" => "omar@example.com", "password" => "00000"],
        ["email" => "badr@example.com", "password" => "01010"]
    ];
